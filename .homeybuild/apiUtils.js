...
exports.globalThrottleManager = exports.ThrottleManager = void 0;
 ...
 */
async function retryWithBackoff(fn, maxRetries = 3, initialDelay = 1000, maxDelay = 10000) {
    let lastError;
...
class ThrottleManager {
     ...
     */
    async throttle(key, fn, minDelay = 5000) {
...
exports.globalThrottleManager = new ThrottleManager();
